...
<template>
        ...
        >
        <!-- Background image -->
        <div class="pointer-events-none fixed inset-0 overflow-clip">
            <img
        ...
        <main
            class="relative isolate mx-auto grid max-w-[1000px] flex-grow place-items-center px-8 max-md:pt-16 md:h-full xl:max-w-6xl"
        >
            <div
        ...
        <footer class="relative pb-3 md:fixed md:inset-x-0 md:bottom-0">
            ...
            <!-- White noise -->
            <div
                class="absolute inset-x-0 bottom-0 h-4 bg-[url(/resources/images/white-noise.gif)]"
            ></div>
            <!-- Pictogram -->
            <svg
